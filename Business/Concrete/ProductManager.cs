...
//Autofac kullanma sebebimiz .net mimarisindede var ve ınterceptor görevi veriyor(bütün sınıflar için)
namespace Business.Concrete
{
    ...
    public class ProductManager : IProductService
    {
        ...
        {
            //atıyorum sistem 19'da kapansın saat
        ...
        [ValidationAspect(typeof(ProductValidator))]
        [CacheRemoveAspect("IProductService.Get")] //ürün güncellendiği zaman 
